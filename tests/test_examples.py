...
def test_sliding_ruler(tmp_path):
    o = gauge.round_gauge.Object()
    ...
    exporter = gauge.exporter.Object()
    out_file = tmp_path / "ruler.png"
    exporter.export(o, out_file)
    assert out_file.exists()


if __name__ == "__main__":
    test_basic_gauge(tmp_path=pathlib.Path("/tmp"))
    ...
    test_sliding_ruler(tmp_path=pathlib.Path("/tmp"))
